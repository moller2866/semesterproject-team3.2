...
public class Worker extends NPC{
    ...
    Worker(String name,double x, double y) {
        ...
        setTalk("""
                Great, if you want to help unload the ship, you should grab the 
                bucket here in the recycling center. You can fill it with the 
                plastic from the ship and then empty it in the container to the
                east of the recycling center. You should be able to fit 10 pieces
                of plastic in the bucket.
