...
public class Worker extends NPC{
    ...
    Worker(String name,double x, double y) {
        ...
        setTalk("""
                ...
                Hey, did you know that it is estimated that every year between 4.8 and 12.7 million tons of plastic enter the ocean. That is 4.8 and 12.7 million tons of plastic enter the ocean. That is into the ocean every minute. We have our work cut out for us!
                """);
    }
